...
- `configs` table — allowlist of subreddits with their VDB name, analytics URL, optional CTA config (joined via `cta_id`), and `query_subreddit_allowlist` (filters VDB results to posts from specific subreddits).
